...
- [ ] **title 맨 앞 이모지 1개 의무** (2026-05-26 추가, SERP 디폴트 OG 이미지 식별 약점 보완):
  - 모든 신규 가이드·계산기 title 첫 글자 = 토픽 이모지 1개 + 공백
  - 토픽별 표준 매핑: 가산세 ⚠️ / 경비율·시뮬 📊 / 합산·직장 💼 / 공제·신고 🧾 /
    연금·금융 🏦 / 임차·키 🔑 / 환급·환불 💸 / 회수·경정 🔄 / 주택·집 🏠 /
    분납·시간 ⏰ / 의료·병원 🏥 / 가족 👨‍👩‍👧 / 양도·매매 💰 / 환율 💱 / 면적·평수 📐
  - title 60자 이내 유지 (이모지 포함 카운트)
  - 효과: SERP 첫 글자 시각 후크 → CTR +5~15% 추정 (디폴트 og 이미지 차별화 부재 보완)
