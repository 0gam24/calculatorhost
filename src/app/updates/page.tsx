...
export const metadata: Metadata = {
  ...
  description:
    '2026년 calculatorhost 계산기·세율·금리 변경 이력 시계열 정리. 신규 계산기 추가, 세법 개정, 규제 변경 등 모든 업데이트를 한 페이지에서 확인.',
  alternates: { canonical: URL },
  openGraph: {
    title: PAGE_TITLE,
    description:
      '2026년 calculatorhost 모든 변경 이력 — 신규·세율·규제·금리·제도 카테고리별 시계열',
    url: URL,
    type: 'article',
  },
  twitter: {
    ...
    description: '2026년 calculatorhost 모든 변경 이력 시계열',
  },
};
...
export default function UpdatesPage() {
  ...
  const webPageLd = buildWebPageJsonLd({
    name: PAGE_TITLE,
    description:
      '2026년 calculatorhost 모든 계산기·세율·금리·제도 변경 이력 시계열',
    url: URL,
