...
const ALL_CALCULATORS: CalcCategory[] = [
  ...
  // 금융
  {
    ...
    items: [
      ...
      { href: '/calculator/averaging-down', title: '주식 물타기' },
            ...
            <article className="mx-auto max-w-6xl space-y-10">
              ...
              <header>
                <h1 className="mb-4 text-4xl font-bold tracking-tight lg:text-5xl" style={{ letterSpacing: '-0.02em' }}>
                  <span className="text-primary-500">27개</span> 한국 생활 계산기,{' '}
              ...
              {/* 전체 계산기 목록 */}
              <section className="space-y-6">
                <h2 className="text-2xl font-bold text-text-primary">전체 계산기 (27개)</h2>
