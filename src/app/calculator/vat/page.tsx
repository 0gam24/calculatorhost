...
export const metadata: Metadata = {
  title: '부가가치세 계산기 2026 | 일반·간이·환산 | calculatorhost',
  description:
    '2026년 부가가치세 계산기. 일반과세·간이과세·환산청구 등 사업 유형별로 부가세를 계산하고, 납부액·신용카드 수수료를 한 번에 파악. 무료. 회원가입 불필요. 모바일·데스크톱 최적. 2026년 최신 세율 반영.',
  keywords: [
    '부가세 계산기',
    'VAT 계산기',
    '부가가치세 계산',
