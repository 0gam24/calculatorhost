...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      '85㎡ 이하 주택은 농어촌특별세가 면제되어 취득세 + 지방교육세만 부과됩니다. 85㎡를 초과하면 과세표준의 0.2%(일반) 또는 1%(중과)의 농어촌특별세(농특세법 §5)가 추가되므로, 같은 가격 10억 원 기준으로 약 200~500만 원의 추가 세금이 발생합니다.',
  },
  {
            ...
            <div className="mx-auto flex max-w-4xl flex-col gap-8">
              ...
              >
                ...
                <p className="text-text-secondary" data-speakable>
                  ...
                  중과세율이 적용됩니다(지방세법 §13의2). 85㎡ 초과 주택은 농어촌특별세(농특세법 §5)
                  0.2~1%가 추가되고, 지방교육세는 취득세의 10%(지방세법 §150)로 계산되어 실제 부담은
