...
export const metadata: Metadata = {
  ...
  description:
    '2026년 N잡러(다중 직업 보유자) 건강보험 계산기. 직장·자영업·프리랜서 소득을 입력하면 월 건강보험료와 피부양자 탈락 여부를 즉시 계산합니다. 다중 소득 통합 관리 필수.',
      ...
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        <main className="flex-1 px-4 py-6 sm:px-6 lg:px-8">
          <article className="mx-auto max-w-4xl">
            ...
            {/* AD-2 중간 광고 */}
            <div className="my-8">
              <AdSlot slot="n-jobber-insurance-mid" format="rectangle" />
            </div>
            ...
            {/* AD-4 인피드 광고 */}
            <div className="my-8">
              <AdSlot slot="n-jobber-insurance-feed" format="fluid" />
            </div>
        ...
        <aside className="hidden w-80 bg-bg-base p-4 lg:block">
          <div className="sticky top-[5rem]">
            <AdSlot slot="n-jobber-insurance-side" format="vertical" />
          </div>
        </aside>
      </div>

      {/* AD-5 모바일 앵커 광고 */}
      <MobileAnchorAd slot="n-jobber-insurance-anchor" />
