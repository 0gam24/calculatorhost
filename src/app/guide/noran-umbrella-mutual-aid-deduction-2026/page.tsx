          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 이 한도는 실제 납입한 부금 범위 안에서만 인정됩니다. 예를 들어 사업소득금액이 3천만원이라도 연 300만원만 납입했다면 공제액은 300만원입니다. 한도까지 공제를 채우려면 소득 구간에 맞춰 납입액을 설계해야 합니다. 법인 대표는 소득 요건이 별도이므로 중소기업중앙회에서 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 절세액은 본인의 과세표준 구간(한계세율)에 따라 달라지며, 위 계산은 다른 공제를 고려하지 않은 단순 예시입니다. 실제 세액은 종합소득세 신고 시 전체 공제·세액공제를 함께 반영해 산출됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 실질과세 원칙(국세기본법 §14)상 명목이 아닌 실질에 따라 과세되므로, 절세만을 노린 단기 가입 후 해지는 오히려 손해입니다. 노란우산공제는 최소 폐업·노후 시점까지 유지할 수 있는 여력 안에서 가입하는 것이 핵심입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 소득공제(노란우산)는 한계세율이 높은 고소득자에게 유리하고, 세액공제(연금저축)는 세율과 무관하게 정률로 공제되어 상대적으로 중·저소득자에게 유리합니다. 자신의 소득 구간에 따라 우선순위를 정하되, 여력이 되면 두 제도를 병행하는 것이 절세 폭을 넓히는 방법입니다.
                </p>
              </section>
