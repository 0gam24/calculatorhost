          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 분납은 재산세 본세(지방세법 §3에 따른 재산세)에만 적용됩니다. 지방교육세, 도시지역분, 지역자원시설세 등 부가세목은 별도이므로, 위택스에서 본세 기준으로 정확히 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 분납 신청 후 기한 내에 모든 분납금을 완납해야만 가산금이 면제됩니다. 분납금 중 하나라도 기한을 넘기면 그 이후부터 가산금이 발생하므로, 신청 시 확실히 납부 가능한 일정을 계획해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 천재지변이나 납세자의 정당한 사정(질병·실업·재해)이 있으면 기한 연장을 신청할 수 있습니다. 이 경우 관할 세무서에 서류와 함께 연장 신청을 하면 됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  주의: 1기와 2기는 완전히 별개이므로, 1기에 분납했다고 해서 2기 분납이 자동으로 신청되지 않습니다. 2기도 250만원을 초과하면 다시 신청해야 합니다. 또한 각 기의 분납 한도도 각각 계산됩니다.
                </p>
              </section>
