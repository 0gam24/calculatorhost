          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 모든 기타소득에 60%가 적용되는 것은 아닙니다. 상금·복권당첨금 등은 항목별로 경비율이 다르고, 서화·골동품 양도는 별도 규정을 따릅니다. 60%는 강연·원고·자문 같은 인적용역과 일부 무형자산 대여·양도에 한정된다는 점을 기억하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 8.8%는 원천징수 단계의 세율일 뿐, 최종 세금이 아닐 수 있습니다. 기타소득금액이 300만원을 넘으면 종합과세로 정산되므로 세율이 달라집니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 지급처가 3.3%(사업소득)로 뗐는지 8.8%(기타소득)로 뗐는지 원천징수영수증을 꼭 확인하세요. 세목이 잘못 처리되면 5월 신고에서 정정해야 하며, 실질과세 원칙(국세기본법 §14)상 실제 반복성으로 최종 판단됩니다.
                </p>
              </section>
