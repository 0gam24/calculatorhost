          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 임의계속가입 보험료도 회사 부담분 없이 본인이 내야 하므로, 재직 중 실제 급여 공제액보다는 높을 수 있습니다. 그럼에도 재산이 반영된 지역보험료보다는 낮은 경우가 많아 비교가 필요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 신청 후 첫 보험료를 납부기한부터 2개월이 지나도록 내지 않으면 임의계속가입 자격이 상실됩니다. 신청만 하고 납부를 미루면 무효가 되니 주의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 신청 기한(최초 지역보험료 납부기한에서 2개월)이 지나면 소급 신청이 되지 않습니다. 퇴직 후 첫 고지서를 받으면 즉시 검토하는 습관이 필요합니다.
                </p>
              </section>
