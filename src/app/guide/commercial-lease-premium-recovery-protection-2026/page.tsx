          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 이 보호는 임차인이 신규임차인을 실제로 주선했을 때 작동합니다. 아무도 주선하지 않은 채 임대인의 태도만 문제 삼으면 방해행위를 입증하기 어렵습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 임대인에게 정당한 사유가 있으면 거절이 허용됩니다. 신규임차인의 지급 능력이 없거나, 임대인이 목적물을 1년 6개월 이상 비영리로 사용하려는 경우 등이 그 예입니다(§10의4②).
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 권리금 분쟁은 사실관계와 입증이 복잡해 법률 전문가의 조력이 필요한 경우가 많습니다. 대한법률구조공단이나 상가건물임대차분쟁조정위원회의 도움을 받는 것도 방법입니다.
                </p>
              </section>
