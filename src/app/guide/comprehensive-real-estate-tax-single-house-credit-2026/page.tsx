          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 연령 확인 기준은 부과 기준년도의 1월 1일입니다. 예를 들어 2026년 종부세 부과 기준년도는 2025년이므로, 2025년 1월 1일 현재 연령을 적용합니다. 따라서 생일이 1월 2일 이후라면 신년을 기준으로 공제율이 바뀐다는 점도 유의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 보유 기간이 5년 미만이면 장기보유 세액공제를 받을 수 없습니다. 또한 주택을 처분했다가 다시 취득한 경우, 처분 전 보유 기간과 재취득 후 보유 기간을 구분하여 계산하므로 주의가 필요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 특례 신청은 매년 해야 하며, 신청 기한을 놓치면 그 연도에는 특례를 받을 수 없습니다. 또한 부부 중 한 명이 사망하면 특례 적용이 변경될 수 있으므로, 변화가 있을 때마다 세무서에 신고하는 것이 중요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 1세대1주택 판단은 개별 상황에 따라 복잡할 수 있으므로, 특수한 경우라면 반드시 관할 세무서에 직접 문의하여 확인하는 것이 안전합니다.
                </p>
              </section>
