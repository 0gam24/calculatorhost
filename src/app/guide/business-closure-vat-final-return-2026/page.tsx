          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 면허·허가·신고 업종(음식점, 학원, 부동산중개 등)은 세무서 폐업신고와 별도로 관할 지자체·소관 기관에 폐업신고를 해야 하는 경우가 있습니다. 세무 폐업만 하면 인허가가 살아 있어 추후 과태료가 나올 수 있으므로 소관 기관에 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 경과 과세기간은 6개월 단위(1과세기간=6개월)로 세며, 감가율은 자산 종류에 따라 다릅니다. 정확한 경과 기간·시가 판단은 사례마다 달라지므로, 자산 규모가 크면 세무대리인의 검토를 받는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 간이과세자도 납부의무가 면제될 뿐, 신고의무까지 없어지는 것은 아닙니다. 무신고 상태로 두면 나중에 자료상 매출이 확인될 때 곤란해질 수 있으므로, 면제 대상이라도 신고서는 제출하는 편이 안전합니다.
                </p>
              </section>
