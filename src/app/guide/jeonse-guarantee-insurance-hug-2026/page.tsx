          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 반환보증은 만능이 아닙니다. 가입 조건을 충족해야 하고, 보증사고 발생 시에도 서류 심사·현장 확인 등 절차가 필요합니다. 무조건 즉시 지급되는 것은 아니라는 점을 미리 이해해 두는 것이 좋습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 위 기준은 HUG의 표준 공고에 근거한 요약입니다. 청년·신혼부부 특례, 지방 소도시 우대 등 상품별 세부 조건이 다를 수 있으므로, 실제 가입 전에는 반드시 HUG 홈페이지 또는 안심전세 앱에서 최신 공고를 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 서류상 근생인데 실거주하는 이른바 "근생빌라"는 최근 몇 년간 사고가 반복되며 특히 심사가 엄격해졌습니다. 시세보다 저렴한 매물은 이런 등기 문제인 경우가 많으니, 계약 전 반드시 건축물대장을 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 기한을 지켰다고 반드시 승인되는 것은 아닙니다. 부채비율 초과나 서류 미비 등으로 반려될 수 있으므로, 여유 있게 미리 신청하고 보완 요청에 대응할 시간을 확보하는 것이 현실적입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 어느 기관이든 부채비율이 지나치게 높거나 근생·불법 건축물인 경우 가입이 어렵습니다. 문제가 있다면 세 기관 어디도 해결책이 되지 못하므로, 계약 전 등기부등본·건축물대장 확인이 가장 근본적인 방어선입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 승인이 즉시 나는 것은 아닙니다. 서류 보완 요청이 오는 경우 접수부터 보증서 발급까지 2~4주가 걸릴 수 있으므로, 계약기간 1/2 마감일에 임박해 신청하는 것은 피하는 것이 좋습니다.
                </p>
              </section>
