          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 국내 거래소의 대면거래 확인, 자금세탁방지(AML) 규제, 금융감시 강화 등은 이미 진행 중입니다. 비과세라고 해서 완전한 무규제는 아니라는 점을 기억하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 현재(2026.7)의 정책 방향이며, 시행 전까지 국세청의 추가 지침, 시행령 개정, 또는 재유예 가능성이 있습니다. 국세청 공식 발표를 주기적으로 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 12월 31일 시가를 정확히 어떻게 산정할지(국내 거래소 기준인지, 국제 거래소 기준인지, 가중평균인지)는 시행령에서 구체화될 예정입니다. 국세청 공식 발표를 기다려야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 가이드는 현재(2026.7) 정책 방향을 기반으로 작성되었습니다. 실제 시행 전에 국세청이 발표하는 시행령, 법령 개정안, 종합소득세 신고 서식 등을 반드시 확인하세요.
                </p>
              </section>
