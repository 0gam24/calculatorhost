          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 연 납입한도(2,000만원)와 총 누적 한도(1억원)가 있습니다. 또한 비과세 한도는 매년 초기화되며, 한 해에 200만원(또는 400만원) 초과 이익이 나면 그 초과분만 9.9%로 과세됩니다. 3년 의무가입 만료 후 인출할 때 최종 계산됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 사망, 중증질환, 기초생활수급자 전락 등의 특수한 사유는 중도해지가 허용될 수 있습니다. 정확한 기준은 금융기관에 문의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 ISA 계좌 외의 거래(일반 증권계좌, 국민은행 예금 등)는 ISA와 손익통산할 수 없습니다. ISA 내부끼리만 상계됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 일반형·서민형·농어민형은 중복 가입 불가입니다. 계좌는 1개만 유지할 수 있습니다.
                </p>
              </section>
