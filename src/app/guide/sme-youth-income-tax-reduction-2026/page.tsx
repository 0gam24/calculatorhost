          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 모든 대상에 과세기간별 200만원 한도가 공통 적용됩니다. 감면율이 90%라도 연 200만원까지만 깎이므로, 소득이 아주 높으면 실제 혜택률은 줄어듭니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 병역 차감은 실제 복무기간만 인정되며 최대 6년입니다. 산업기능요원·공중보건의 등 대체복무도 포함되지만, 정확한 인정 범위는 취업 시 회사·세무서에 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 감면 신청 기한을 넘겨도 소급 적용이 가능하지만, 회사가 감면 대상 명세서를 제출해야 처리됩니다. 이직·퇴사 등으로 기록 확인이 어려울 수 있으니 신청서 사본을 보관해 두세요.
                </p>
              </section>
