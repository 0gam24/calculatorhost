          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 한도를 초과하는 보험료는 공제 대상이 아닙니다. 예를 들어 일반 보장성보험료를 150만원 냈다면, 100만원만 공제되고 나머지 50만원은 공제 불가입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 자동차보험은 손해보험이라도 공제 대상이 아닙니다. 이는 자동차보험이 의무 가입이고 손해배상 목적이라는 정책 판단 때문입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 태아는 출생하지 않았으므로 기본공제대상이 아닙니다. 따라서 출생 전 태아보험 보험료는 공제되지 않습니다. 출생 후 신생아를 피보험자로 하는 보험료부터 공제 대상입니다.
                </p>
              </section>
