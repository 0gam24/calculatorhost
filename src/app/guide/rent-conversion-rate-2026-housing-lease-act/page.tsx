...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      '높은 경우가 있지만, 법정 한도를 넘는 부분은 효력이 없습니다. 서울·수도권 일부에서는 시장 관행으로 5~6% 이상을 요구하기도 하지만, 법정 한도(기준금리 + 2%) 를 초과하는 부분은 임차인이 부당이득 반환을 청구할 수 있습니다. 따라서 임대인은 법 한도 안에서 협상하는 것이 안전하며, 분쟁 시 주택임대차분쟁조정위원회를 활용할 수 있습니다.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '이 페이지 하단 "관련 계산기" 섹션의 전월세 전환 계산기에서 보증금·월세·전환율을 입력하면 양방향 환산 결과를 즉시 확인할 수 있습니다. 기준금리 + 2% 법정 한도도 자동으로 표시됩니다.',
  },
];
