          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 원천징수율 15.4%는 금융소득 2,000만원 이하일 때의 "분리과세" 기준이며, 초과 시에는 초과분이 다른 종합소득과 합산되어 누진세율(6~45%)이 적용됩니다. 따라서 "15.4%가 최종 세율"이라는 가정은 위험합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 ISA(개인종합자산관리계좌)와 연금계좌(401k·IRP) 내 배당·이자는 이 기준에서 제외됩니다. 각 특수 계좌의 규칙을 별도로 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 그로스업과 배당세액공제는 상당히 복잡한 계산이고, 개인 투자자가 정확히 파악하기 어렵습니다. 금융소득이 2,000만원을 초과할 것으로 예상되면, 종합소득세 신고 시 세무사나 국세청 상담을 반드시 받으세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 환율 변동에 따라 배당금의 실제 금액이 달라지고, 외국납부세액공제 계산 기준도 매년 국세청 고시를 따릅니다. 정확한 정보는 국세청 홈택스나 세무사에게 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 ISA와 연금계좌 규칙은 연도마다 변경될 수 있으므로, 가입 전에 금융기관에서 최신 기준을 반드시 확인하세요.
                </p>
              </section>
