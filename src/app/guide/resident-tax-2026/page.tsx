          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 개인이면서 사업소도 운영한다면 개인분과 사업소분(경우에 따라 종업원분)을 모두 내야 할 수 있습니다. 유형은 서로 배타적이지 않습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 정확한 조례 세액과 지방교육세 합산액은 지자체마다 다릅니다. 본인 고지 금액은 위택스(wetax.go.kr) 또는 관할 시·군·구청에서 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 기본세율 구간과 금액은 지자체 조례로 가감될 수 있습니다. 실제 사업소분 세액은 위택스 신고 화면이나 관할 지자체에서 확인하는 것이 정확합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 지자체는 조례로 표준세율의 50% 범위에서 세율을 가감할 수 있고, 면세점 기준은 시행령에 따르므로 정확한 금액은 관할 지자체에서 확인하세요.
                </p>
              </section>
