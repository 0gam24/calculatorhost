          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 등기 완료 전에 주민등록을 이전하고 이사하면 대항력을 상실하므로, 반드시 임차권등기가 완료된 후에 이사해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <p className="mt-4">
                  ⚠️ 다만 아무리 임차권등기명령이 있어도 임대인이 정말로 돈이 없으면 돌려받지 못할 수 있습니다. 임차권등기명령은 우선순위를 보장하는 것이지, 없는 돈을 만들어주는 것은 아닙니다. 따라서 가능하면 계약 단계에서 임차인이 확정일자나 전세권설정을 받고, 지속적으로 임대인의 재정 상태를 모니터링하는 것이 가장 좋은 예방책입니다.
                </p>
              </section>
