          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 불공제 매입세액은 소득세·법인세 신고 시 필요경비(또는 손금)로 인정되는 경우가 많습니다. 즉, 부가세 공제는 못 받아도 종합소득세·법인세에서는 비용 처리가 가능하다는 점을 함께 기억하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 예외 조항이 많으므로 개별 지출마다 성격을 정확히 판정해야 합니다. 특히 3번 승용차, 4번 접대비, 7번 사업자등록 전 매입은 실무자들이 가장 자주 실수하는 3대 함정이므로 아래 개별 섹션에서 자세히 다룹니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 예외로 회의비, 복리후생비, 광고선전비는 접대비와 성격이 다르므로 매입세액 공제가 가능합니다. 다만 명목만 회의비이고 실질이 접대라면 세무조사 시 재분류되어 부당공제 문제가 발생할 수 있으니 증빙 관리가 중요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 공제 가능 차종이라도 실제 사업용으로 사용해야 하며, 개인용 겸용 시 안분 계산이 필요합니다. 차량운행일지 등 증빙을 미리 갖춰두지 않으면 세무조사에서 소명하기 어려우므로 유의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 세금계산서 발급 시기가 지연되어 지연발급된 경우에는 발급 시점의 과세기간 매입세액으로 공제받을 수 있으나, 가산세가 부과됩니다. 매입 즉시 세금계산서를 수취하고 국세청 e세로에서 실시간으로 확인하는 습관이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 예외로 사업자등록 신청일이 등록 전 매입세액의 공제 기한을 지났다 하더라도, 등록 후 정상적으로 발생하는 매입세액은 당연히 공제됩니다. 즉, 이 규정은 "등록 이전 지출한 부가세"의 소급 공제 기한에 대한 것임을 정확히 이해해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 자진 수정신고 시 감면 폭은 신고 시점에 따라 달라지며(6개월 이내 90%, 1년 이내 75% 등), 세무조사 개시 통지 이후에는 감면이 적용되지 않으므로 이상 발견 즉시 조치가 중요합니다.
                </p>
              </section>
