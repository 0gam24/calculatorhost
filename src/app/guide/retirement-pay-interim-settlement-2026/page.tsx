          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 법정 사유 없이 이루어진 중간정산은 무효로 볼 수 있습니다. 이 경우 퇴직 시 종전 근속기간까지 합산해 퇴직금을 다시 산정해야 할 수 있으므로, 회사와 근로자 모두 요건을 정확히 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 요양 사유는 6개월 이상 요양과 함께 의료비 부담 정도 등 세부 요건이 붙습니다. 근로시간 단축 사유도 단축 폭·기간 기준이 있으므로, 정확한 요건은 고용노동부 또는 회사 담당 부서에서 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 개인별 세부담 차이는 급여 수준·근속기간·중간정산 시점에 따라 달라집니다. 중간정산 전 회사나 세무 전문가에게 예상 퇴직소득세(소득세법 §55) 변화를 확인하는 것이 안전합니다.
                </p>
                <p className="mt-4">
