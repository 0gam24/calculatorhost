          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 하이브리드 자동차(HEV, PHEV)는 내연기관 배기량이 있으므로 §127①제1호 배기량 과세 대상이며, 차령경감이 적용됩니다. 전기차와는 다르니 주의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 신청 기간은 <strong>매년 1월 1~31일만</strong> 가능합니다. 2월 이후에 신청하면 선납일수가 줄어들어 할인액도 감소합니다. 예를 들어 3월에 신청하면 선납일수가 273일이 되어 실효 할인율은 약 3.74%가 됩니다.
                </p>
              </section>
