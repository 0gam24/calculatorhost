          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 조기재취업수당은 자동으로 지급되지 않습니다. 재취업일로부터 12개월이 지난 후 별도의 청구 절차를 거쳐야만 지급받을 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 이직 전 사업주 또는 그와 밀접하게 관련된 사업주에게 재고용된 경우는 지급 대상에서 제외됩니다. 자회사나 계열사로 이동한 경우도 해당될 수 있으므로 재취업 전 고용센터에 미리 확인하는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 구직급여일액에는 고용노동부 고시에 따른 상한액·하한액이 적용됩니다. 실제 자신의 구직급여일액은 실업급여 수급자격증 또는 고용센터 안내문에서 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 잔여일수 기준일은 재취업일 "전날"이므로, 재취업일 자체를 며칠 앞당기거나 늦추는 것만으로 하루 차이가 요건 충족 여부를 가를 수 있습니다. 정확한 잔여일수는 고용센터 또는 워크넷 실업인정 내역에서 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 이직일 당시 65세 이상인 경우 등은 청구 시기나 근속 확인 방식에서 예외가 적용될 수 있으므로(시행령 §84), 정확한 절차는 관할 고용센터에서 확인하는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 개별 사정에 따라 예외가 인정되는 경우도 있으므로, 청구 전 반드시 관할 고용센터 또는 고용보험 홈페이지(ei.go.kr)에서 자신의 상황을 확인하는 것이 가장 정확합니다.
                </p>
              </section>
