          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 KRX 금시장에서 실물로 인출하는 순간부터는 부가가치세법 §9의 재화 공급에 해당해 부가세 10%가 부과됩니다. 실물 소유가 반드시 필요한 경우가 아니라면 계좌에 그대로 두는 편이 세제상 유리합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 혜택은 시장 안에서 거래를 이어갈 때만 유지됩니다. 보관기관에 예치된 금을 실물 골드바로 인출하는 순간 조세특례제한법 §126의7과 부가가치세법 §9의 결합 효과로 부가세 10%가 새로 부과됩니다. 실물 반출은 신중하게 결정해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 사업 목적으로 대량 매매하거나 반복적으로 매매하면 사업소득 또는 기타소득으로 재분류될 수 있습니다. 단순 개인 재산 보유 목적을 넘어서면 국세기본법 §14의 실질과세 원칙에 따라 별도 판단이 이루어질 수 있으니 유의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이자·배당 소득이 이미 있는 경우 문제가 커질 수 있습니다. 금통장 차익은 배당소득이라 다른 이자·배당과 합산해 연 2천만원을 초과하면 금융소득종합과세에 편입됩니다. 종합소득 최고 세율은 지방세 포함 49.5%까지 오르므로 고소득자는 KRX 금시장이나 해외 금 ETF로 우회하는 것이 유리할 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 실제 선택은 세금 외에도 유동성, 매매 스프레드, 접근성, 실물 보관비 등을 함께 따져야 합니다. 한 방식만 고집하기보다 목적별로 나눠서 KRX와 금 ETF, 골드바를 병행하는 사례도 많습니다. 특정 상품 매수를 권유하는 정보가 아니라는 점을 기억해 주세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 종합과세 여부 판단은 다른 금융소득 규모와 소득 구성에 따라 크게 달라집니다. 고소득 근로자, 사업소득자, 부동산 임대소득자는 종합소득세 최고 세율 구간과 맞물릴 위험이 있으므로 세무사와 상담 후 방식을 결정하는 것이 안전합니다.
                </p>
              </section>
