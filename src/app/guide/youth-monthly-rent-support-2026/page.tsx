          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 실제 월 지원 상한, 지급 개월 수, 소급 인정 여부 등 세부 조건은 반드시 복지로 공고문과 거주지 지자체 안내에서 최신 값을 확인해야 합니다. 예외적으로 지자체 자체 예산으로 국토교통부 기준보다 확대 지원하는 지역도 있으므로, 거주지 시·군·구청 주거복지 담당 부서에 문의해 두면 정확합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 위 항목들도 상황에 따라 예외가 있을 수 있고, 지자체 담당자의 판단이 개입되는 부분이 있습니다. 애매한 상황이라면 신청 전 관할 행정복지센터에 상담 예약을 잡아 서면 안내를 받아 두는 것이 안전합니다.
                </p>
              </section>
