          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 대학생의 경우 900만원 한도가 있으므로, 학기당 450만원 이상의 교육비를 내야 연 900만원 한도를 모두 활용할 수 있습니다. 또한 본인의 대학원 등록금은 한도 없이 전액 공제되지만, 배우자나 성인 자녀의 대학원 교육비는 일반적으로 공제 대상이 아닙니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 보육료나 유치원 납입금은 별도의 "보육비 세액공제"(소득세법 §59의3) 대상이므로 중복 공제할 수 없습니다. 교육비인지 보육비인지 불명확한 경우, 세무서에 사전 확인 후 신고하는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 본인의 교육비는 소득 제한이 없습니다. 예를 들어 연봉 1억인 직장인이 대학원에 다니면서 등록금을 낸 경우, 등록금 전액이 공제됩니다. 자녀와 본인을 혼동하지 않도록 주의하세요.
                </p>
              </section>
