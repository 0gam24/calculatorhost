...
export const metadata: Metadata = {
  ...
  description:
    '통상임금의 정의와 계산법을 정리했습니다. 정기상여금을 포함하도록 바뀐 2024년 대법원 판례의 의미, 시간급 통상임금을 구하는 순서, 그 값이 연장·야간·휴일수당에 어떻게 반영되는지를 근로기준법 §2·§56 기준으로 설명합니다.',
  keywords: [
    '통상임금',
    '정기상여금',
    '연장수당',
          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 판례 변경 이후 통상임금 인정 여부는 여전히 사안별로 판단됩니다. 판례가 "고정성을 요하지 않는다"고 했다는 것이 곧 "모든 상여금이 통상임금"이라는 뜻은 아닙니다. 정기적·일률적인지가 핵심입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 위 표는 일반적 경향일 뿐, 최종 판단은 개별 근로계약서·취업규칙·임금규정·지급 현황을 종합적으로 봅니다. 기업마다 구조가 다르므로 명확하지 않으면 노사 협의 또는 고용노동부 상담을 추천합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 위 계산은 단순화한 예시입니다. 실제로는 근로계약서·취업규칙·임금규정의 상여금 규정을 정확히 확인해야 합니다. 재직조건부 상여의 경우 지급 시기·조건에 따라 통상임금 판정이 달라질 수 있습니다.
                </p>
              </section>
