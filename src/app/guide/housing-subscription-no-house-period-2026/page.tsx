        ...
        <div className="flex">
          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <AdSlot slot="guide-housing-subscription-no-house-period-top" format="horizontal" />
              ...
              <AdSlot slot="guide-housing-subscription-no-house-period-mid" format="rectangle" />
