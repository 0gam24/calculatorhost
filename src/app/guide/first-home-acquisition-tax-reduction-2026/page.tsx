          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 본인이 무주택이라도 배우자가 과거에 주택을 소유했던 적이 있으면 감면을 받을 수 없습니다. 또한 배우자의 주택 소유 이력은 법정 결혼(혼인신고)을 기준으로 판단되며, 혼인 전 배우자가 소유했던 주택은 영향을 미칠 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 거주요건 위반 판정은 복잡할 수 있습니다. 예를 들어 직장 이전, 질병, 출장 등 불가피한 사유가 있으면 기간 연장이나 감면 유지가 가능한 경우도 있으므로, 거주하지 못할 상황이 생기면 반드시 관할 세무서에 먼저 문의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <p className="mt-4">
                  ⚠️ 다만 국회에서 감면 기한을 연장하거나 변경할 수 있으므로, 2026년 중반 이후 법 개정 뉴스를 꼭 확인하세요. 특히 2027년 이후 취득 예정인 경우, 매년 세법 개정 소식을 관심 있게 봐야 합니다.
                </p>
              </section>
