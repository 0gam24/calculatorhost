          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 적용 기준은 계약일이 아니라 그 주택에 설정된 담보물권(근저당 등)의 설정일입니다. 오래된 근저당이 있으면 개정 전의 낮은 기준이 적용될 수 있으므로, 계약 전 등기부등본으로 선순위 근저당 설정일을 반드시 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 확정일자는 최우선변제 요건 자체는 아니지만, 범위를 넘는 보증금의 나머지 부분을 순위대로 돌려받는 우선변제권을 위해 반드시 함께 받아 두는 것이 안전합니다. 대항요건과 확정일자는 이사 당일 함께 처리하는 것이 원칙입니다.
                </p>
              </section>
