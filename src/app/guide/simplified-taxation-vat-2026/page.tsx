          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 업종 자체가 간이과세 배제 대상이면 매출이 작아도 간이과세를 적용받을 수 없습니다. 광업, 제조업(일부 소매 제외), 도매업, 부동산매매업, 변호사·세무사 등 전문직 사업서비스업이 대표적입니다(부가가치세법 §61 ① 각 호).
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 부가율은 시행령 개정으로 바뀔 수 있고 업종 분류가 애매한 경우도 많습니다. 자신의 업종코드에 맞는 정확한 부가율은 홈택스 신고 화면 또는 세무서를 통해 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 창업 초기 인테리어·장비 매입세액이 수백만원이면, 간이과세는 그 세액을 환급받지 못합니다. 이럴 때는 간이과세를 포기하고 일반과세로 환급받는 편이 유리할 수 있습니다(부가가치세법 §70). 단, 포기하면 3년간 간이과세로 복귀할 수 없습니다.
                </p>
              </section>
