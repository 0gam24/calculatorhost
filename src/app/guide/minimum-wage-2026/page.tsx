          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 금액은 최저임금 기준일 뿐입니다. 실제 급여에는 초과근무수당, 야근수당, 상여금, 식대 등이 추가될 수 있으며, 회사별로 지급 방식이 다를 수 있으므로 개별 계약을 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 수습이라고 해서 모든 감액이 가능한 것은 아닙니다. 계약서에 "수습 기간"이 명시되어 있어야 하며, 회사가 임의로 감액할 수 없습니다. 불명확하면 고용노동부에 문의하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 최저임금 위반이 의심되면 즉시 회사에 문의하거나 고용노동부에 신고하는 것이 좋습니다. 개인적으로 소송하기보다 기관의 보호를 받는 것이 효과적입니다.
                </p>
              </section>
