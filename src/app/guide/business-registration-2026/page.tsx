          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 간이과세는 업종 제한이 있습니다. 제조업(음식료품·의류 제조), 도매업, 부동산매매업, 사용 목적이 비영리인 경우는 간이 적용 대상이 아니므로, 홈택스 시스템이나 세무서에 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <div className="rounded-lg border border-border-base bg-bg-card p-4 space-y-3 mt-4">
                  ...
                  <p className="text-sm text-text-secondary">
                    ...
                    <br />
                    <br />
                    다만 세금계산서를 발급해야 하는 경우(거래처 요청, 연 4,800만원 이상)는 일반과세로 전환해야 세금계산서를 발급할 수 있습니다.
                  </p>
                </div>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 일반과세를 선택하면 모든 거래의 세금계산서를 관리해야 하고, 분기마다(또는 반기마다) 부가세를 신고해야 합니다. 기장 복잡도가 높아지므로 회계사 도움이 필요할 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 업종 분류는 국세청의 "표준산업분류"에 따르므로, 홈택스 시스템에서 정확히 확인하거나 세무서에 직접 문의하는 것이 가장 안전합니다. 예를 들어 "1인 브랜드 패션 판매"는 제조(맞춤)인지 소매(판매)인지에 따라 판정이 달라질 수 있습니다.
                </p>
              </section>
