          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 1,500만원 한도는 세액공제를 받은 연금계좌 납입액과 운용수익에서 나오는 연금액을 기준으로 합니다. 이미 세금을 낸 원금(세액공제 안 받은 납입분)에서 나오는 연금은 과세 대상이 아니니 혼동하지 마세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 종신형은 사망 시까지 받는 대신 중도 해지·인출이 제한됩니다. 세율이 낮다고 무조건 유리한 게 아니라, 목돈이 필요할 가능성과 함께 따져봐야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 공적연금도 다른 소득과 합쳐 종합과세되므로, 은퇴 후 사업·근로·금융 소득이 있으면 5월 종합소득세 신고 대상이 될 수 있습니다.
                </p>
              </section>
