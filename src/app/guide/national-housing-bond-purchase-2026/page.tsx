          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 국민주택채권은 주택 외에도 토지·건물 등기, 각종 인허가 등에도 매입 의무가 있으므로, 본 가이드는 주택 소유권이전등기 상황을 중심으로 설명합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 위 표의 매입률 수치는 구조 이해를 돕기 위한 예시일 뿐이며, 실제 고시 매입률은 주택도시기금법 시행령 §8 별표 개정에 따라 달라질 수 있습니다. 등기 신청 전 반드시 주택도시기금 사이트(nhuf.molit.go.kr)에서 시가표준액과 지역을 입력해 실제 매입금액을 재계산하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 할인율은 채권시장 금리에 따라 매일 달라지는 값이라, 같은 조건이라도 매입 시점이 다르면 본인부담금도 달라집니다. 위 사례는 계산 구조를 보여주기 위한 것으로, 실제 거래 전에는 반드시 매입 당일 고시된 매입률·할인율로 다시 계산해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  다만 매입금액 계산 결과 단수(1만원 미만)가 생기면 채권 발행 규정에 따라 절사되며, 이는 창구 시스템이 자동으로 처리하므로 신청인이 별도로 계산할 필요는 없습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 신축 등 시가표준액이 아직 고시되지 않은 부동산은 별도의 산정 기준이 적용될 수 있으므로, 이 경우 관할 등기소 또는 주택도시기금 고객센터에 문의해야 합니다.
                </p>
              </section>
