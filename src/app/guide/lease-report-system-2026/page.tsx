          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 신고제는 세금 부과가 목적이 아닙니다. 신고 자체로 임대소득세가 새로 매겨지는 것은 아니며, 임대소득 과세는 별도의 소득 기준에 따릅니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 대상 지역은 수도권 전역, 광역시, 세종시, 도의 시 지역 등으로 지정되어 있으며 일부 군 지역은 제외됩니다. 본인 주택 소재지가 대상 지역인지는 관할 지자체나 부동산거래관리시스템에서 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 계약서 원본 또는 사본이 반드시 필요합니다. 계약서가 없으면 신고가 지연될 수 있으니, 계약 직후 계약서를 확보해 30일 안에 처리하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 과태료 금액과 부과 세부 기준은 지자체 운영에 따라 달라질 수 있습니다. 기한을 놓쳤더라도 최대한 빨리 신고하면 지연 기간이 짧아져 과태료가 줄어듭니다.
                </p>
              </section>
