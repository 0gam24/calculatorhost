          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 기부금 공제 대상은 법정기부금(대한적십자사, 자선단체 등)으로 한정되므로, 모든 단체에 낸 돈이 공제 대상이 되는 것은 아닙니다. 기부할 때 기부 단체가 "세액공제 대상"인지 반드시 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 정치자금 기부금도 소득금액의 100%를 한도로 하므로, 과도한 기부는 한도를 초과할 수 있습니다. 대형 기부자는 이월공제 대상이 될 수 있으므로 세무사와 상담하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 고향사랑기부금은 연간 기부 한도가 있을 수 있으므로, 기부 전 해당 지자체의 규칙을 확인하세요. 또한 답례품 선택 시 배송 시간이 소요되므로 계획적으로 기부하는 것이 좋습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 한도 초과분을 이월공제할 때는 종합소득세 신고 시 명시해야 합니다. 자동으로 이월되는 것이 아니므로, 신고 시 이전 연도의 초과분이 있는지 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 개인사업자 기부금 처리는 매우 복잡하므로, 세무사 또는 관할 세무서에 상담받는 것이 안전합니다. 잘못 신고하면 가산세 대상이 될 수 있습니다.
                </p>
              </section>
