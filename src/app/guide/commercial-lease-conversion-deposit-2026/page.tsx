          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 환산보증금 기준을 넘는다고 해서 임차인이 법의 보호에서 완전히 벗어나는 것은 아닙니다. 계약갱신요구권, 권리금 회수기회 보호, 대항력 등 핵심 조항은 기준과 무관하게 모든 상가 임차인에게 적용됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 부가가치세가 별도로 표시된 계약서라면, 부가세 포함 금액을 그대로 반영하면 환산보증금이 실제보다 부풀려집니다. 반드시 공급가액(부가세 제외)만 월차임으로 산정하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 기준 금액은 시행령 개정으로 바뀔 수 있습니다. 계약 시점의 최신 기준은 반드시 법제처 국가법령정보센터에서 다시 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 증액 상한과 우선변제권을 못 받는다고 해서 임차인이 완전히 무방비 상태가 되는 것은 아닙니다. 계약갱신요구권과 권리금 보호만으로도 실무상 가장 중요한 보호는 대부분 유지됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <p className="mt-4">
                  다만 환산보증금 계산은 단순해 보여도, 부가세 포함 여부나 관리비의 차임 산입 여부 등 세부 쟁점에서 다툼이 생길 수 있습니다. 계약 전 임대인과 서면으로 조건을 명확히 정리해두는 것이 가장 확실한 예방책입니다.
                </p>
              </section>
