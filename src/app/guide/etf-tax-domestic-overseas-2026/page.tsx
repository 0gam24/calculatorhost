          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 배당소득세 15.4%는 10% 국세 + 2.6% 지방소득세 + 2.8% 농어촌특별세의 합계입니다. 현지 원천징수가 있는 해외상장 ETF는 추가로 환율 변동과 외국 납부세액공제를 고려해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <div className="rounded-lg border border-border-base bg-bg-card p-4 space-y-3 mt-4">
                  ...
                  <p className="text-sm text-text-secondary">
                    ...
                    <br />
                    <span className="text-xs text-text-tertiary">결론: 600만원이 기본 15.4% 대신 더 높은 세율로 과세될 수 있음. ⚠️ 다만 해외상장 ETF 양도소득은 분류과세(종합 대상 제외).</span>
                  </p>
                </div>
                <p className="mt-4">
                  ⚠️ 다만 주의할 점은 해외상장 ETF의 양도소득입니다. 양도소득은 분류과세(따로 분리 과세)이므로 2000만원 한도에 포함되지 않습니다. 예를 들어 해외 ETF 양도소득 1000만원은 별도로 22% 양도소득세를 내면서, 동시에 배당 소득만으로 2000만원을 초과하면 그 초과분을 종합과세하는 식입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 ISA는 주식·펀드·신탁 등 여러 자산군을 섞어 운용해야 하고, 해외주식·해외 ETF는 ISA 대상에 포함되지 않을 수 있으므로 사전 확인이 필요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 해외상장 ETF의 양도소득세 22%는 기본공제 250만원이 있으므로 1000만원 차익이면 실제 과세표준은 750만원입니다. 국내상장 해외지수 ETF의 15.4%는 기본공제가 없으므로 상황에 따라 둘의 실효세율이 비슷할 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <p className="mt-4">
                  ⚠️ 다만 절세 목적으로 인위적 거래를 반복하면 국세청이 "실질과세 원칙"(국세기본법 §14)을 적용하여 거래를 인정하지 않을 수 있습니다. 정당한 투자 목적 하에서만 절세 전략을 사용하세요.
                </p>
              </section>
