          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 세 가지 권리는 모두 사전 신청이 필수입니다. 자동으로 발생하지 않으므로, 전세 계약 직후 즉시 행동해야 합니다. 특히 우선변제권과 최우선변제는 "언제" 받았는지가 매우 중요합니다. 근저당 등기일보다 나중에 확정일자를 받으면 우선변제권을 못 받거나 보호 범위가 줄어들 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 집주인의 기존 채무(근저당 등기)의 순서는 대항력으로 영향을 받지 않습니다. 대항력은 "이사 후 집주인이 바뀌어도 임차권이 계속 유효하다"는 뜻일 뿐, 기존 담보권자들과의 우선순위를 바꾸지는 못합니다. 그 역할은 다음의 우선변제권이 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 만약 세입자의 확정일자가 임대인의 사채보다 나중이었다면, 사채업자가 2순위가 되어 세입자보다 먼저 배당을 받을 수 있습니다. 따라서 전세 계약 직후 최대한 빨리 확정일자를 받는 것이 매우 중요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 최우선변제도 제한이 있습니다. ① 최우선변제 금액이 주택가액의 1/2을 초과하면, 주택가액의 1/2까지만 보호됩니다. ② 보증금이 기준액보다 크면 초과분은 우선변제권으로만 보호되고, 그마저도 후순위 담보권자 영향을 받습니다. 따라서 "지역별 기준액 이상의 전세는 위험하다"는 통설이 나옵니다.
                </p>
              </section>
