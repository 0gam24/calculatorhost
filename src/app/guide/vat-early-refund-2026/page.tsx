          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 조기환급은 "선제적 현금 지원"일 뿐, 향후 사업이 계획대로 진행될 것을 전제합니다. 설비 투자 후 사업을 폐업했거나, 설비를 개인용으로 전용하거나, 영세율 요건을 잃으면 국세청이 환급액을 추징할 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 정확한 서류와 신청 절차는 관할 세무서마다 약간씩 다를 수 있습니다. 신청 전에 관할 세무서에 미리 문의하여 필요한 서류 목록을 확인하는 것이 안전합니다.
                </p>
              </section>
