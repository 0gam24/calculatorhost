          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 여기서 "직계비속"에는 손주뿐 아니라 증손주도 포함되며, 세대를 두 단계 이상 건너뛰어도 할증률은 동일하게 적용됩니다. 20억원 판정은 해당 증여 건의 증여재산가액을 기준으로 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 이는 단순 비교이며, 자녀가 이미 보유한 재산 규모, 향후 상속 계획, 증여 시점에 따라 결과가 달라집니다. 거액 증여는 반드시 세무 전문가와 시뮬레이션한 뒤 결정하세요.
                </p>
              </section>
