          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 표는 일반적인 육아휴직(한 부모만 사용)의 기준입니다. 부모 모두가 육아휴직을 사용하는 경우(6+6 부모육아휴직제)에는 월 상한액이 인상될 수 있으므로, 아래 부모제 섹션을 참조하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 정확한 월 상한액 인상 규모와 적용 조건은 매년 고용노동부 고시에 따라 변동될 수 있습니다. 2026년 현행 상한액 인상 규모는 고용센터나 work24.go.kr에서 반드시 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 고용보험 가입 요건, 자녀 대상 나이, 복직 요건 등은 법 개정에 따라 변동될 수 있습니다. 정확한 2026년 기준은 고용센터나 work24.go.kr에서 직접 확인하세요.
                </p>
              </section>
