          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 주택용 오피스텔이라 해도 2주택 이상 보유 시에는 중과세가 적용됩니다. 기존 주택을 이미 보유 중이라면 현재 구입하는 오피스텔은 "2주택째" 세율이 적용되므로 1.0~3.0% 기본율에 +20~30%p 추가되어 8~9%대가 될 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 주거용 오피스텔이라 하더라도 2주택 이상 보유 중이면 특례를 받지 못합니다. 또한 토지와 건물이 별도로 과세되는데, 부동산 공시가 기준이 적용되므로 실제 보유 위치와 시장 변동에 따라 매년 달라질 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 주거용 오피스텔이 "주택"으로 분류되면 종부세 과세 기준에 포함되므로, 기존 주택 1채와 오피스텔 1채 보유 시 3주택 판정이 되는 건 아니지만, 보유액 합계가 공제금액(1세대1주택 12억, 다주택 9억)을 초과하면 종부세가 부과될 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 주거용으로 구분해도 양도 시점의 공시가가 12억원을 초과하면 비과세 대상에서 제외됩니다. 공시가 12억원, 양도가 13억원이면 초과분 1억원에 대해서만 양도세가 부과됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  주의: 부가세 환급은 일시적 혜택입니다. 사용 용도를 변경할 계획이 있다면 처음부터 신중하게 검토하세요. 환급받은 부가세 때문에 나중에 더 큰 세금을 낼 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  주의: 실제 판정은 세무서에서 합니다. 겉으로는 주거용이라 주장해도 거주 증거(전입신고, 공과금, 근처 주민 증언 등)가 없으면 인정받지 못할 수 있습니다. 반대로 임대 사무실로 운영하지만 가끔 쉬러 간다면? 세무서 판정이 엄격할 수 있으니 명확히 하세요.
                </p>
              </section>
