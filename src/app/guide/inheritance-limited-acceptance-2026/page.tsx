...
export const metadata: Metadata = {
  ...
  description:
    '물려받을 빚이 재산보다 많을 때 고르는 한정승인과 상속포기를 비교했습니다. 민법 §1019가 정한 3개월 기한, 두 제도의 결정적 차이, 법원 신고 절차, 후순위 상속인에게 빚이 넘어가는 함정 사례까지 정리했습니다.',
  keywords: [
    '상속 한정승인',
    '상속포기',
    '상속채무',
          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 3개월 동안 아무것도 하지 않으면 자동으로 단순승인(민법 §1026 "법정단순승인")이 되어 채무를 무제한 책임져야 합니다. 따라서 채무 상황이 불명확할 때는 반드시 법원에 신고해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 한정승인 신고 후에도 상속재산을 소극적으로 처분(예: 청소비 지출)할 수 없습니다. 상속재산 건축, 수리, 기본 관리만 허용되며, 나머지는 채권자 목록 공시와 재산 공고를 통해 절차적으로 진행되어야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 상속포기를 하면 채무도 없지만 재산도 받을 수 없으며, 그 상속분은 후순위 상속인에게 넘어갑니다. 예를 들어 자녀 3명이 모두 포기하면, 손자녀나 형제자매(피상속인의 형제)가 상속을 받아야 하고, 그들도 채무를 부담하게 될 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 민법 §1019③ "특별한정승인" 규정에 따라, 3개월 내 단순승인했더라도 나중에 상속채무가 상속재산을 초과하는 사실을 중대한 과실 없이 발견한 경우, 그 사실을 안 날부터 다시 3개월 내에 한정승인을 신고할 수 있습니다. 이 경우 법원에 정황을 설명하고 특별한정승인 신청을 하면 됩니다.
                </p>
              </section>
