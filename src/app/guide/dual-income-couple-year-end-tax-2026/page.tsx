          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 모든 배분이 항상 정해진 답은 아닙니다. 부부의 구체적인 소득, 공제 지출액, 총급여 구간이 다르므로, 반드시 홈택스 시뮬레이션으로 비교해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 한계세율만 보고 배분을 정하면 안 됩니다. 의료비 공제처럼 3% 또는 25% "기준"이 있는 경우, 기준이 낮은 배우자가 받는 것이 더 유리할 수 있기 때문입니다. 반드시 전체 공제를 함께 고려해야 합니다.
                </p>
              </section>
