...
const FAQ_ITEMS = [
  {
    ...
    answer:
      '2026년부터 국민연금 보험료율은 9%에서 9.5%로 인상됩니다(국민연금법 §88). 직장가입자는 근로자 4.75%, 사업주 4.75%씩 부담하며, 지역가입자와 임의가입자는 전액 본인이 낸다는 점이 다릅니다. 이후 2027년 10%, 2028년 10.5% 등 매년 0.5%p씩 2033년까지 인상될 예정입니다.',
  },
  {
            ...
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <div>
                ...
                <p className="mb-4 text-base text-text-primary" data-speakable>
                  국민연금 보험료율은 2026년 1월부터 <strong>9.5%</strong>로 인상됩니다(국민연금법 제88조). 이는 2025년까지의 9.0% 요율에서 0.5%포인트 올라간 것입니다. 직장가입자의 경우 근로자가 4.75%, 사업주가 4.75%씩 부담합니다. 지역가입자와 임의가입자는 본인이 전액을 냅니다.
                </p>
                <RateBarChart
