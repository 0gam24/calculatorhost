          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 사업용계좌는 사업 전용일 필요는 없습니다. 소득세법 §160의5는 계좌 명의나 전용 여부가 아니라 국세청에 사업용으로 등록된 계좌를 통해 결제·수취하도록 요구합니다. 실무적으로는 개인 지출과 섞이면 장부 정리가 복잡해지므로 분리 운용을 권장합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 전문직 사업자(변호사·회계사·세무사·의사 등)와 성실신고확인대상자는 수입금액과 무관하게 별도 규정에 따라 장부 작성 의무가 있을 수 있으므로, 개별 상황은 관할 세무서 또는 세무대리인에게 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 사업 양수, 상속, 폐업 후 재개업 등 특수한 경우 과세기간 개시일이 통상과 다를 수 있습니다. 이때는 개시일을 기준으로 6개월을 계산해야 하므로, 정확한 기한은 관할 세무서에 사전 확인하는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 임차료·인건비를 개인 통장으로 실수로 이체했다면, 즉시 사업용계좌로 다시 정리하거나 회계 처리 시 사업용 지출임을 명확히 기록해야 향후 세무조사에서 미사용 가산세 소명이 가능합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 수입금액 기준을 초과했음에도 간편장부로 신고하면 무기장가산세와 별도의 신고 불성실 가산세가 부과될 수 있으므로, 매년 5월 신고 전에 자신의 지위를 정확히 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 홈택스 화면 구성과 메뉴 이름은 국세청 시스템 개편에 따라 달라질 수 있습니다. 메뉴가 안 보이면 홈택스 상단 검색창에 "사업용계좌"를 입력하면 최신 위치를 안내받을 수 있습니다.
                </p>
              </section>
