          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 이 비과세는 국내 상장주식을 증권시장에서 매도할 때에 한합니다. 해외주식, 비상장주식, 장외거래는 소액주주라도 양도세 대상이 되니 구분이 필요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 지분율 판정에서는 본인 외에 특수관계인의 보유분이 합산될 수 있고, 판정 세부 기준은 상황에 따라 달라질 수 있습니다. 보유 규모가 기준에 가깝다면 국세청 또는 증권사·세무 전문가에게 정확한 판정을 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 세제는 개정될 수 있고 대주주 판정은 특수관계인 합산 등 변수가 많습니다. 보유액이 기준에 근접하면 매매 전에 반드시 최신 기준과 개별 판정을 확인하세요.
                </p>
              </section>
