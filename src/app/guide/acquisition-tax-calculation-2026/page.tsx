...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      '지방교육세는 취득세액의 10%입니다(지방세법 §151). 취득세 500만원이면 지방교육세 50만원을 추가로 내게 됩니다. 총 납부액 = 취득세 + 지방교육세(+ 농특세)이므로 모두 합산하여 계산하세요.',
  },
  {
          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6">
                ...
                <p>
                  <strong>지방교육세 = 취득세 × 10%</strong> (지방세법 §151). 취득세를 계산한 후 그 금액의 10%를 추가로 내게 됩니다.
                </p>
