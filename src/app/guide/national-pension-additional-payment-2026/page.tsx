          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 추납은 국민연금 가입 이력이 있는 사람만 신청할 수 있는 제도입니다. 국민연금에 한 번도 가입한 적이 없다면 추납 대상 자체가 존재하지 않으므로, 우선 임의가입부터 신청해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 분할납부 회차를 늘릴수록 완납까지 걸리는 기간도 길어져, 가입기간이 실제로 모두 복원되는 시점 역시 늦춰집니다. 노령연금 수급 시기가 임박했다면 완납 일정을 미리 계산해두는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 이 개정이 모든 기존 신청 건에 소급 적용되는지는 신청 시점과 개별 사정에 따라 달라질 수 있으므로, 이미 추납을 신청했거나 진행 중이라면 국민연금공단에 정확한 적용 기준을 확인하는 것이 필요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 추납만으로 항상 수급요건이 채워지는 것은 아닙니다. 추납 한도가 최대 119개월로 제한되어 있어, 미납 기간이 이보다 훨씬 길다면 추납만으로는 부족분을 전부 메우지 못할 수 있습니다. 이 경우 임의계속가입 등 다른 제도와 병행을 검토해야 합니다.
                </p>
              </section>
