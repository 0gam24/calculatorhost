          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 세액공제를 안 받은 원금이라도 그 돈에서 불어난 운용수익은 과세 대상입니다. "내가 낸 원금이니 세금이 없겠지"라고 단정하지 말고, 금융회사에 과세대상 금액을 정확히 조회하는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 부득이한 사유는 스스로 판단해 적용받는 것이 아니라, 사유 발생일로부터 일정 기간 내에 증빙을 갖춰 금융회사에 신청해야 인정됩니다. 신청을 놓치면 같은 사정이어도 16.5%가 적용될 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 담보대출을 받고도 상환하지 못하면 결국 계좌가 해지되어 기타소득세가 발생할 수 있습니다. 대안도 상환 계획이 있을 때 유효하다는 점을 기억하세요.
                </p>
              </section>
