          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 "1주택"의 범위는 주의가 필요합니다. 기준시가 9억원 이하의 1주택과 피상속인 소유 주택은 중복 포함될 수 있으므로, 정확한 판정은 국세청 홈택스나 세무서에 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 위 한도(600~2,000만원)는 장기주택저당차입금 이자상환액 공제에만 적용되는 별도 한도입니다. 청약저축 소득공제(§87)·주택임차차입금 원리금상환액 공제 등 다른 주택자금공제는 각각 별도 규정이 적용되므로, 여러 공제를 함께 받는다면 국세청 홈택스에서 정확한 적용 한도를 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 신축 주택 취득 시나 세대주 변경, 증축 등의 상황에서는 판단이 복잡할 수 있으므로, 확실하지 않으면 세무서에 사전 상담받으세요.
                </p>
              </section>
