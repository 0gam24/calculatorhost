          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 필요경비는 스스로 챙겨야 인정됩니다. 국세청이 알아서 빼주지 않으므로, 취득 당시 계약서와 보유 기간에 지출한 공사·수수료 증빙을 신고 때 함께 제출해야 반영됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 보유 기간에 매년 낸 재산세·종합부동산세, 대출 이자, 관리비는 보유·관리 비용으로 보아 필요경비에서 제외됩니다. 취득·양도 시점의 세금·수수료만 반영된다는 점을 구분하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 개별 사례는 공사 범위와 목적에 따라 국세청 판단이 달라질 수 있습니다. 애매한 지출은 관할 세무서나 세무대리인에게 확인하고, 공사계약서에 시공 내용을 구체적으로 남겨두세요.
                </p>
              </section>
