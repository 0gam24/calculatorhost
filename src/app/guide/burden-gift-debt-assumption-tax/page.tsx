...
export const metadata: Metadata = {
  ...
  description:
    '부담부증여 양도세+증여세 분리 계산식. 채무인수액은 양도세, 무상분은 증여세로 과세. 자산 10억+채무 4억 예시 1.55억 세금 시뮬. 전세보증금·은행대출 입증 방법, 함정 5가지, 5월 신고 절차 완벽 정리.',
  keywords: [
    '부담부증여',
    '채무인수 증여세',
    '전세보증금 부담부증여',
          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section aria-label="함정 5가지" className="card border-l-4 border-l-danger-500">
                <h2 className="mb-3 text-xl font-semibold">주의: 부담부증여 함정 5가지</h2>
