          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 간편장부대상자라도 복식부기로 신고하는 것은 언제든 가능하며, 오히려 기장세액공제(연 100만원 한도) 혜택을 받을 수 있습니다. 매출이 복식부기 기준선에 가까워지고 있다면 미리 전환해 두는 것이 유리합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 소규모사업자 예외는 &lsquo;가산세 면제&rsquo;일 뿐 &lsquo;장부를 안 써도 유리&rsquo;라는 뜻은 아닙니다. 실제 경비 지출이 단순경비율보다 많다면 간편장부를 작성해 실제 경비를 인정받는 것이 세금 측면에서 더 이득입니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  다만 결손금 이월공제는 &lsquo;기장&rsquo;을 전제로 하므로, 간편장부대상자라도 반드시 장부를 작성해야 이 혜택을 누릴 수 있습니다. 창업 초기라면 세무대리인 위탁이 어렵더라도 국세청 무료 간편장부 양식을 활용해 최소한의 기록을 남기세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  주의: 예외적으로 앞서 설명한 전문직 사업자(의사·변호사·세무사 등)는 신규 개업 첫 해부터 수입금액과 무관하게 복식부기의무자입니다. 개업 초부터 회계 프로그램과 세무대리인 선임을 고려해야 합니다.
                </p>
              </section>
