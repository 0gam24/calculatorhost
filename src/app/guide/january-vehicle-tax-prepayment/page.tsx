...
export const metadata: Metadata = {
  title: '자동차세 연납 5% 할인 가이드 2026 | calculatorhost',
  description:
    '2026년 1월 16~31일 자동차세 연납 신청·납부 가이드. 약 5% 할인 (지방세법 시행령 §125) + 신용카드 무이자 할부. 한국 거주자 기준 실전 가이드. 법조항·관련 계산기 링크 포함.',
  keywords: [
    '자동차세 연납',
    '자동차세 1월',
    '자동차세 할인',
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      '명목 공제율은 5% (지방세법 시행령 §125)입니다. 선납 일수에 비례해 계산되므로 1월 신청이 최대 절약입니다. 정확한 공제액은 본 계산기의 "연납 할인 적용" 옵션을 체크하면 실시간 확인 가능합니다. 신용카드사 이벤트(캐시백) 결합 시 추가 절약 가능.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '연납 미신청 시 6월 16~30일 1차 (1/2) + 12월 16~31일 2차 (1/2) 분할 납부. 단 본세 10만 원 이하면 6월에 일괄. 연납 대비 5% 한도 내 손해. 정확한 금액은 본 계산기에서 확인 가능.',
  },
  {
    question: '경차도 연납 할인 받나요?',
    answer:
      '네, 모든 차량 가능. 단 경차는 연 자동차세 자체가 작아(1000cc = 약 10.4만/년) 절대 할인액은 5% 한도 내입니다. 그래도 위택스에서 1분이면 신청 가능하니 이득.',
  },
  {
...
export default function JanuaryVehicleTaxPage() {
  ...
  const articleLd = buildArticleJsonLd({
    ...
    keywords: ['자동차세 연납', '5% 할인', '위택스', '무이자 할부'],
  });
  const webPageLd = buildWebPageJsonLd({
    name: '자동차세 연납 5% 할인 가이드 2026',
    description: '2026년 1월 16~31일 자동차세 연납 신청·납부 가이드. 5% 한도 내 공제 (선납 일수에 비례) + 신용카드 무이자 할부 + 위택스/모바일 신청법.',
    url: URL,
    datePublished: DATE_PUBLISHED,
    dateModified: DATE_MODIFIED,
  });
            ...
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section aria-label="할인율표" className="card">
                ...
                <div className="rounded-lg border border-border-base bg-bg-card p-4 text-sm">
                  ...
                  <p className="text-text-secondary">본 계산기의 "연납 할인 적용" 옵션을 체크하면 배기량과 신청 월을 기준으로 실시간 공제액을 확인할 수 있습니다.</p>
                </div>
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="bg-primary-500/10 border border-border-base">
                        ...
                        <th className="px-3 py-2 text-right">설명</th>
                      </tr>
                    </thead>
                    <tbody className="text-text-secondary">
                      ...
                      <tr className="border border-border-base">
                        ...
                        <td className="px-3 py-2 text-right">1월 대비 선납 일수 감소로 공제액 감소</td>
                      </tr>
                      <tr className="border border-border-base">
                        <td className="px-3 py-2">6월 신청</td>
                        <td className="px-3 py-2 text-right">선납 일수 더욱 감소</td>
                      </tr>
                      <tr className="border border-border-base">
                        <td className="px-3 py-2">9월 신청</td>
                        <td className="px-3 py-2 text-right">최소 공제 (연말 임박)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <ShareButtons title="자동차세 연납 5% 할인 가이드 (2026)" url={URL} description="1월 신청 시 5% 한도 내 공제. 위택스 신청법 + 계산기." />
