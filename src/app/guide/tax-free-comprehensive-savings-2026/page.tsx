          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 비과세는 이자·배당에만 적용됩니다. 주식 매매차익처럼 원래 비과세이거나 다른 세목이 적용되는 소득에는 이 제도가 별도로 의미가 없습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 2026년부터 만 65세 이상 대상은 기초연금을 받는 사람만 신규가입할 수 있도록 요건이 강화됐습니다. 기초연금을 받지 않는 65세 이상은 신규가입이 제한되므로, 본인이 대상인지 금융회사에서 먼저 확인해야 합니다. 이미 가입한 계좌는 그대로 유지됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 제도의 신규가입 요건과 일몰 시한은 세법 개정으로 자주 조정됩니다. 가입 시점의 정확한 요건은 반드시 은행 등 금융회사와 국세청에서 확인하세요.
                </p>
              </section>
