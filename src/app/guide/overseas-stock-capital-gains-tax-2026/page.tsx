          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 국내 대주주 양도소득이 동일 과세년도에 있다면, 둘을 합산한 후 총 250만원 공제를 한 번만 적용합니다. 예를 들어 해외주식 차익 300만원 + 국내주식 차익 300만원 = 총 600만원이면, (600 − 250) × 22% = 77만원을 납부합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 외국에서 이미 양도소득세를 낸 경우, 외국납부세액공제를 신청해 한국 세금에서 그 금액만큼 공제받을 수 있습니다. 미국은 개인 주식 양도에 원천징수를 하지 않으므로 보통 미국 세금 부담이 없지만, 다른 국가는 다를 수 있으니 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 손실을 다음해로 이월할 수는 없습니다. 2026년 손실이 2027년 이익과 통산되지 않으므로, 해마다 독립적으로 계산해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 미국의 IRA, 401k 등 은퇴계좌 내 주식 양도나, 싱가포르 등 다른 국가의 특수 계좌 내 거래는 이중과세 규정이 복잡하므로 세무전문가와 상담하는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <p className="mt-4">
                  다만 해외 은퇴계좌(미국 IRA, 401k 등)는 한국 세무와 이중과세 문제가 발생할 수 있으므로, 이 경우는 반드시 세무전문가에게 상담받으세요.
                </p>
              </section>
