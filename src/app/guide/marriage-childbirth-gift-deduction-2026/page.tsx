          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 1억원 한도는 재산을 받는 사람(수증자) 한 명 기준이며, 부모·조부모 등 모든 직계존속에게서 받은 금액을 합산해 계산합니다. 아버지에게 1억, 할아버지에게 1억을 따로 받아 2억을 공제받는 구조는 성립하지 않습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 증여일이 2024년 1월 1일보다 앞서면 공제 대상이 아닙니다. 2023년에 결혼하며 받은 증여는 이 특례를 적용받을 수 없습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 공제 후 세액이 0원이라고 신고를 생략하면, 훗날 부동산 취득 등 자금 출처 소명이 필요할 때 증여받은 사실을 입증하기 어려워질 수 있습니다. 반드시 신고를 남겨두세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 개별 사정에 따라 적용 여부가 달라질 수 있으므로, 고액 증여나 부동산 증여를 계획한다면 국세청 상담 또는 세무사 검토를 거치는 것이 안전합니다.
                </p>
              </section>
