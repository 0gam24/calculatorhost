          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 총급여액은 비과세 소득(월 20만원 식대 등)을 제외한 과세 대상 급여액입니다. 또한 연도 중간에 퇴직하거나 입사한 경우 그 해의 총급여액을 기준으로 판단합니다. 불명확하면 세무서에 문의하는 것이 안전합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 주택청약저축은 주택마련 저축을 지원하는 정책이므로, 소득공제 형태로 설계되어 있습니다. 절세액이 크지는 않지만, 매년 꾸준히 쌓인다면 누적 효과는 상당합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 추징은 당첨 후 일정 기간 내에 당첨자 본인이 신고해야 적용됩니다. 신고하지 않으면 나중에 세무조사 때 적발될 수 있으므로, 당첨 후에는 반드시 은행이나 세무서에 알리세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 2028년 기한 종료 후 새로 시작하는 납입액은 소득공제 대상이 되지 않을 가능성이 높습니다. 혜택을 받으려면 2028년 12월 31일 이전에 공제 대상 납입이 완료되어야 합니다.
                </p>
              </section>
