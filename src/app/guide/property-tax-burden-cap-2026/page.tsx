          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 상한율은 재산세 본세에만 적용됩니다. 지방교육세, 도시지역분, 지역자원시설세 등 부가세목은 별도의 세율과 계산 기준이 있을 수 있으므로, 정확한 최종 납부액은 위택스(wetax.go.kr)에서 반드시 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 정확한 적용 여부와 계산은 개별 주택의 상황에 따라 달라지므로, 의심스러울 때는 관할 시·군·구청 세무서 또는 위택스에서 직접 확인하는 것이 가장 안전합니다.
                </p>
              </section>
