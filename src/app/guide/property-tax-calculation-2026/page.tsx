          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 특례세율의 정확한 %는 행정안전부 고시와 지자체 조례에 따라 달라지므로, <strong>재산세 계산기 또는 해당 시군구 세무서</strong>에 직접 확인하시기 바랍니다. 또한 공시가격이 9억원을 초과하면 특례가 적용되지 않으며, 일반세율을 적용받습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 도시지역(지방세법 §112)에 위치한 주택은 추가로 도시지역분이 부과될 수 있으므로, 정확한 납부액은 세무서의 납세 통지서를 확인하세요.
                </p>
              </section>
