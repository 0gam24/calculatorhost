          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 성실신고확인 대상이라고 해서 세무조사를 면제받는 것은 아닙니다. 오히려 국세청이 고수입 개인사업자를 관리하는 수단 중 하나이므로, 대상자로 통보받으면 절차를 소홀히 하지 말아야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 기준은 직전연도 수입금액을 기준으로 하므로, 올해 수입이 급증했어도 당해연도에는 대상이 아닐 수 있습니다. 반대로 올해 수입이 줄었더라도 작년 수입이 기준을 넘었다면 대상자입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 실제 판정에는 겸업 여부, 사업장 통합·분리 여부 등 세부 사정이 반영되므로, 기준 금액 근처에 있다면 반드시 세무사와 함께 정확한 수입금액을 재계산해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 부가가치세 신고나 다른 세목의 신고기한까지 연장되는 것은 아닙니다. 성실신고확인 대상자라도 부가가치세는 일반 일정대로 신고해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 확인비용 세액공제는 성실신고확인서를 실제로 제출한 경우에만 적용됩니다. 확인만 받고 서류를 첨부하지 않으면 공제 자체가 부인될 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 가산세보다 더 큰 리스크는 세무조사 선정 가능성입니다. 성실신고확인서 미제출은 국세청이 고수입 사업자의 신고 성실도를 판단하는 주요 지표 중 하나이므로, 대상자라면 기한 내 제출을 최우선으로 챙겨야 합니다.
                </p>
              </section>
