...
export const GUIDES: GuideEntry[] = [
  ...
  // 2026-08-25 신규 5편 (연말정산추가공제·자동차구입세금·초단시간근로자·엔젤투자소득공제·농어촌주택특례)
  {
    ...
    description:
      '기본공제에 더해지는 추가공제 4종. 경로우대 100만원, 장애인 200만원, 부녀자 50만원, 한부모 100만원의 공제액과 소득·나이 요건, 부녀자·한부모 중복 규칙까지 소득세법 §51 기준으로 정리.',
    category: '세금',
    publishedAt: '2026-08-25',
    readingMinutes: 8,
  },
  {
    slug: 'car-purchase-taxes-breakdown-2026',
    title: '자동차 살 때 세금 2026, 개소세·교육세·부가세·취득세',
    description:
      '새 차를 사면 개별소비세 5%, 교육세 30%, 부가가치세 10%, 취득세 7%가 순서대로 붙습니다. 공급가액 3천만원 차량 기준 세금 총액과 계산 순서, 전기차·경차 감면까지 정리(개별소비세법 §1, 지방세법 §12).',
    category: '세금',
    publishedAt: '2026-08-25',
    readingMinutes: 8,
  },
  {
    slug: 'ultra-short-time-worker-rights-2026',
    title: '초단시간 근로자 2026, 주15시간 미만 주휴·연차·퇴직금',
    description:
      '주 15시간 미만 초단시간 근로자는 주휴수당·연차·퇴직금이 원칙적으로 제외되지만 최저임금·산재보험은 반드시 적용됩니다. 4대보험 가입 여부와 실제 근로시간 판단까지 근로기준법 §18 기준으로 정리.',
    category: '근로',
    publishedAt: '2026-08-25',
    readingMinutes: 8,
  },
  {
    slug: 'angel-investment-income-deduction-2026',
    title: '엔젤투자 소득공제 2026, 3천만원까지 100% 공제',
    description:
      '벤처기업·개인투자조합 투자에 대한 소득공제. 3천만원 이하 100%, 5천만원 이하 70%, 초과분 30% 공제율과 종합소득금액 50% 한도, 3년 유지 요건까지 조세특례제한법 §16 기준으로 정리.',
    category: '투자',
    publishedAt: '2026-08-25',
    readingMinutes: 8,
  },
  {
    slug: 'rural-house-one-household-exemption-special-2026',
  ...
  // 2026-08-21 신규 5편 (생산적금융ISA·부양가족소득요건300만·신용카드대중교통공제폐지·고령자지방이주양도세감면·상생임대주택일몰유예)
  {
    ...
    description:
      '2026-08-03 발표 세제개편안이 국내 상장주식·주식형펀드·국민성장펀드·BDC 전용 비과세 계좌 "생산적금융 ISA"를 신설합니다. 이자·배당 전액 비과세, 청년(만 15~34세) 납입금 10% 소득공제, 연 2천만·총 2억 한도, 3년 의무·최대 10년 운용 조건과 일반 ISA와의 차이를 정리합니다(조세특례제한법 §91의18 계열 신설 예정).',
    category: '투자',
    publishedAt: '2026-08-21',
    readingMinutes: 8,
  },
  {
    slug: 'dependent-income-requirement-300-2026-reform',
    title: '부양가족 소득요건 300만 상향 2026 세제개편, 총급여 750만까지',
    description:
      '2026-08-03 세제개편안에 따라 부양가족 기본공제 소득요건이 연 100만원에서 300만원(근로소득만 있는 경우 총급여 500만원에서 750만원)으로 상향됩니다. 근로소득공제 후 소득금액 300만원 컷오프의 계산 근거, 알바 자녀·파트타임 배우자 재편입 사례와 경계값(총급여 800만원 초과 탈락)을 정리했습니다(소득세법 §50, 시행령 §106).',
    category: '세금',
    publishedAt: '2026-08-21',
    readingMinutes: 9,
  },
  {
    slug: 'credit-card-transit-40-percent-abolished-2026-reform',
    title: '신용카드 대중교통 공제 40% 폐지 2026 개편, 15·30% 원위치',
    description:
      '2026-08-03 세제개편안에서 신용카드 대중교통 사용분 우대공제율 40%가 폐지되고 일반 신용카드 15%, 체크·현금영수증 30%로 원위치됩니다. 전통시장 40% 유지, 도서공연 총급여 7천만 초과자 확대, 추가공제 한도 축소(7천만 이하 300만→200만, 초과 200만→100만)까지 사례로 정리했습니다(조세특례제한법 §126의2).',
    category: '세금',
    publishedAt: '2026-08-21',
    readingMinutes: 8,
  },
  {
    slug: 'senior-metro-to-provincial-move-cgt-reduction-2026-reform',
    title: '고령자 지방 이주 양도세 감면 2027, 최대 5억 신설 특례',
    description:
      '2026-08-03 세제개편안, 만 65세 이상 1세대1주택자가 수도권 주택을 팔고 6개월 이내 비수도권으로 이주하면 양도세를 2027년 50%(5억 한도), 2028년 30%(3억 한도) 한시 감면합니다. 5년·2년 거주요건, 사후관리 5년 추징(수도권 재취득·재이주·기존 주택 재매입)까지 조건을 정리했습니다(조세특례제한법 신설 조항 예정).',
    category: '세금·부동산',
    publishedAt: '2026-08-21',
    readingMinutes: 10,
  },
  {
    slug: 'sangsaeng-landlord-sunset-2026-2027-transition',
    title: '상생임대주택 특례 2026 일몰, 유예 양도기한 2027~2029',
    description:
      '상생임대주택 특례가 2026-12-31 일몰되고 2026-08-03 세제개편안이 유예 양도기한을 신설합니다. 2026년 종료 계약은 2027-12-31, 2027년 이후 종료 계약은 종료 후 1년 또는 2029-12-31 중 빠른 날까지 양도해야 2년 거주요건 면제 혜택을 유지합니다(소득세법 시행령 §155의3).',
    category: '세금·부동산',
    publishedAt: '2026-08-21',
    readingMinutes: 9,
  },
