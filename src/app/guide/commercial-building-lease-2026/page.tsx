          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 10년에 도달하면 더 이상의 갱신은 불가능합니다. 임대인이 "더 이상 갱신할 수 없습니다"라고 하면 법적으로 거절할 사유가 없으므로, 이때부터는 새로운 임차인을 모집하거나 상점을 양도해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 5% 상한은 계약갱신 시 적용됩니다. 만약 임차인과 임대인이 합의로 5% 초과 인상에 동의한다면, 이는 법 위반이 아닙니다. 중요한 것은 "임대인이 일방적으로" 5% 초과 금액을 강요할 수 없다는 점입니다.
                </p>
              </section>
