          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 반기신청은 근로소득만 있는 사람에게만 허용됩니다. 사업소득이나 종교인소득이 조금이라도 발생한 경우 반기신청 대상이 아니므로 5월 정기신청을 이용해야 하며, 이 원칙은 부부합산 기준으로 판단합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  예외: 3.3% 원천징수를 받는 프리랜서는 세법상 사업소득자로 분류됩니다. 원천징수영수증 형식이 근로소득(간이세액표 적용)인지, 사업소득(3.3% 원천)인지에 따라 반기신청 가능 여부가 갈리므로 자신의 소득 유형을 정확히 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  주의: 반기신청은 근로소득 외 다른 소득이 없는 경우에만 선택할 수 있습니다. 반기신청을 했더라도 그해 안에 사업소득이 발생하면 정기신청으로 재조정될 수 있고, 소득 구조가 바뀌었을 때 국세청 안내에 따라 신청 방식을 다시 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 신청 기간을 놓쳐도 6개월 이내에는 기한 후 신청이 가능하지만, 산정액의 일부만 지급되므로 감액 부담이 있습니다. 관련 상세는{' '}
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  예외: 선지급 이후 실제 확정 소득이 신청 기준을 넘어서면 정산 시 초과분을 환수당할 수 있습니다. 특히 성과급이나 상여로 하반기 소득이 크게 늘어날 가능성이 있는 경우, 반기신청보다 정기신청이 오히려 안전할 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 총소득 기준금액과 최대지급액은 매년 개정될 수 있으므로 반드시 국세청 홈택스 공고를 기준으로 확인해야 합니다. 본 가이드에서 임의의 원 단위 금액을 인용하지 않는 이유이며, 정확한 최신 금액은 국세청 근로·자녀장려금 안내 페이지에서 확인 가능합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  주의: 반기신청을 선택했다가 그해 안에 사업소득이 발생하면 반기신청 자격을 잃고 정기신청 대상으로 전환됩니다. 이 경우 별도로 5월 정기신청 절차를 진행해야 하며, 국세청 안내를 확인하지 못하면 신청 시기를 놓칠 수 있으니 유의하세요.
                </p>
              </section>
