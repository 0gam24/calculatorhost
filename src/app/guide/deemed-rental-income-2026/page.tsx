          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 1주택(고가주택 제외)이나 2주택 보유자의 전세보증금은 과세 대상이 아닙니다. 즉 대부분의 일반 임대인은 간주임대료와 무관하며, 다주택 전세 임대인에게 적용되는 규정입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 정기예금이자율은 매년 바뀌므로, 신고하는 과세연도에 맞는 고시 이자율을 적용해야 합니다. 아래 사례는 2025년 귀속 3.5%를 기준으로 하며, 실제 신고 시에는 해당 연도 고시 이자율을 국세청에서 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 면적과 기준시가 두 요건을 모두 충족해야 제외됩니다. 40㎡ 이하라도 기준시가가 2억원을 넘으면 소형주택으로 인정되지 않아 주택 수에 포함됩니다.
                </p>
              </section>
