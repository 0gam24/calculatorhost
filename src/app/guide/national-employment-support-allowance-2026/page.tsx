...
const FAQ_ITEMS = [
  {
    ...
    answer:
      '국민취업지원제도는 실업급여의 사각지대에 있는 저소득 구직자에게 소득을 지원하면서 취업을 돕는 제도입니다(구직자 취업촉진 및 생활안정지원에 관한 법률 §7·§19·§20). 1유형은 구직촉진수당을 지급하며, 2유형은 취업활동비용을 지원합니다. 고용보험 실업급여를 받지 못하는 사람도 요건을 갖추면 참여할 수 있습니다.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '1유형 참여자는 구직촉진수당을 6개월간 매월 지급받습니다. 같은 법 §19는 지급액을 고용정책심의회 심의를 거쳐 월 단위로 정하도록 하고 있어 금액은 고시로 바뀝니다. 2026년 기준 월 지급액은 고용노동부가 정하는 금액이며, 부양가족이 있으면 1인당 월 10만원씩 일정 한도까지 추가될 수 있습니다. 정확한 금액과 추가 요건은 고용24와 고용노동부 안내를 반드시 확인하세요.',
  },
  {
          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p>
                  국민취업지원제도는 실업급여를 받지 못하는 저소득 구직자에게 생계를 지원하면서 취업 서비스를 제공하는 제도입니다. 근거 법은 구직자 취업촉진 및 생활안정지원에 관한 법률이며, 수급 요건은 §7, 지급 수준은 §19, 지급기간·절차는 §20에 규정돼 있습니다. 고용보험에 가입하지 못했거나 수급 요건을 채우지 못한 사람도 요건만 맞으면 참여할 수 있어, 이른바 한국형 실업부조로 불립니다.
                </p>
                <p>
              ...
              <section className="space-y-4 rounded-lg border border-border-base bg-bg-card p-6">
                <p className="text-sm text-text-tertiary">
                  <strong>면책조항:</strong> 본 가이드는 교육 목적으로 작성되었으며, 개인 맞춤형 상담이 아닙니다. 구직촉진수당의 정확한 지급액, 소득·재산 기준선, 청년 연령 범위 등은 매년 고용노동부 고시로 조정되므로 본 가이드는 특정 금액을 확정 안내하지 않습니다. 반드시 고용24(work24.go.kr) 또는 고용노동부 고객상담센터(1350)에서 최신 기준을 확인하세요. 본 콘텐츠는 2026-08-13을 기준으로 작성되었으며, 제도 변경 시 업데이트됩니다. 근거 법령: 구직자 취업촉진 및 생활안정지원에 관한 법률 §7(구직촉진수당의 수급 요건)·§19(지급수준 결정)·§20(지급기간 및 지급절차). AI 보조 작성 후 운영자 검수 완료.
                </p>
                <p className="text-sm text-text-tertiary">
                  <strong>참고 자료</strong>:{' '}
