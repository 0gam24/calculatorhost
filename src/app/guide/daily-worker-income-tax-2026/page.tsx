...
export const metadata: Metadata = {
  ...
  description:
    '건설 현장이나 단기 알바로 일한 일용근로자의 원천징수 세금을 계산하는 방법입니다. 일급 15만원 공제와 6% 세율을 적용하는 순서, 분리과세라서 5월 종합소득세 신고에 합산되지 않는 이유를 소득세법 §14③·§134 근거로 정리했습니다.',
  keywords: [
    '일용근로소득세',
    '일급 원천징수',
    '일용근로자 세금',
          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 4대보험(고용보험·산재보험)은 별도로 공제됩니다. 월 60시간 이상 근무하면 가입 대상이므로 보험료도 함께 차감됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 일용근로소득 외에 다른 종류의 소득이 있다면(예: 프리랜서 용역비, 주식 양도차익), 그 소득은 별도로 신고해야 합니다.
                </p>
              </section>
