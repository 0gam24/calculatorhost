          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 공제율이 높다고 해서 무조건 절세되는 것은 아닙니다. 기본한도와 추가한도 내에서 차등 공제되므로, 한도를 먼저 계산한 후 어떤 카드·사용처를 우선할지 판단해야 합니다. 또한 2026년 귀속분(2027년 연말정산)부터 이 제도는 2028년 12월 31일까지 3년 연장되었으므로, 그 이후 제도 존속 여부는 국회 결정에 달려 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 총급여 7천만원을 초과하면 문화·체육 항목이 추가한도 대상에서 제외됩니다. 이 경우 전통시장과 대중교통만 추가한도(200만원) 대상이 되므로 주의해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 제외 항목 판정이 모호한 경우가 있습니다. 예를 들어 약국 구매 중 일부(감기약 등 의약품)는 제외되지만 일반 의약품 취급점에서의 구매 구분이 명확하지 않을 수 있습니다. 이런 경우 국세청 상담센터에 문의하거나 연말정산 작성 시 세무사의 조언을 받는 것이 안전합니다.
                </p>
              </section>
