          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 맞벌이 부부인 경우, 한 명의 배우자가 기본공제를 받는 자녀만 세액공제 대상입니다. 예: 부인이 자녀를 기본공제하면 부인만 자녀세액공제를 받으며, 남편은 같은 자녀에 대해 공제를 받을 수 없습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 2026년 4월 21일부터 연령 기준이 단계적으로 인상되는 규정이 적용됩니다. 자세한 정보는 국세청 공식 공지를 참조하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 출산·입양 공제는 그 해 한 번만 적용되며, 이후 해에는 일반적인 자녀세액공제 규칙을 따릅니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <p className="mt-4">
                  다만 출산·입양 세액공제는 별도의 증명 서류(출생증명서, 입양 관련 서류)가 필요할 수 있으므로, 신청 전에 관련 서류를 준비하는 것이 좋습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 프리랜서·사업가의 경우 소득이 년간 100만원 이상 자녀는 기본공제 대상이 아니므로, 세액공제도 받을 수 없습니다. 예: 대학 다니는 성인 자녀가 아르바이트로 연 150만원을 버는 경우, 그 자녀는 기본공제 대상이 아니므로 자녀세액공제 대상도 아닙니다.
                </p>
              </section>
