          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 가이드는 제도 설명 목적이며, 개별 진료비의 급여·비급여 구분이나 개인별 환급 여부는 국민건강보험공단(1577-1000)에서 반드시 확인해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 요양병원 장기입원자의 경우 별도 기준이 적용될 수 있으며, 세대원 구성 변경이나 소득 재산정으로 분위가 바뀌면 최종 상한액이 달라질 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 요양병원 장기입원 등 일부 경우에는 사전급여 적용 방식·시점이 다르게 운영되므로, 해당 사례는 요양병원 원무팀 또는 공단 지사에 문의해 개별 확인이 필요합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 항목별 급여·비급여 구분은 진료 내용과 규정 개정 상황에 따라 달라질 수 있으므로, 환급 규모를 정확히 알고 싶다면 국민건강보험공단에서 개인별 판정 결과를 조회해야 합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 사망자나 미성년자 등 특수 사례는 유족·법정대리인이 서류를 갖춰 신청해야 하고, 개인 상황에 따라 추가 확인 절차가 붙을 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <p className="mt-4">
                  다만 이 가이드는 일반적인 흐름 설명이며, 개별 계약의 세부 정산 방법은 가입한 보험회사 약관과 지급 심사 결과에 따릅니다. 특정 상품·상황에 대한 확정 판단은 담당 보험사에서 확인하세요.
                </p>
              </section>
