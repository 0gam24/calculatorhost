          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 위 세율은 기본 부과율이고, 자진 수정신고나 기한후신고를 하면 국세기본법 §48에 따라 기간별로 감면됩니다. 세무조사 통지를 받기 전에 스스로 신고하는 것이 감면의 절대 조건입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 예정신고를 놓친 개인사업자가 확정신고 기간에 함께 신고하는 경우, 무신고가산세가 아니라 예정분에 대한 별도 처리 절차가 적용될 수 있습니다. 예정·확정 구분이 애매하면 홈택스 상담 또는 세무대리인 확인을 권장합니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 세법 해석의 차이나 일반적인 오류(예: 매입세액 안분 계산 오류)로 인한 과소신고는 부정행위로 보지 않습니다. 부정행위 판정은 매출 은닉, 이중장부, 거짓 증빙 등 적극적 은닉 행위가 있어야 인정됩니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 세무공무원이 납부고지서를 발부한 이후에는 별도의 가산금·중가산금 체계가 적용될 수 있으며, 국세징수법상의 강제징수 절차로 이어질 수 있습니다. 자진 납부는 지연일수를 줄여 가산세를 최소화하는 유일한 방법입니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 세금계산서 관련 가산세는 유형별로 부과율과 조건이 세밀하게 다르므로, 실제 위반이 확인되면 부가가치세법 §60 원문과 국세청 예규를 세무대리인과 함께 확인하시기 바랍니다.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 위 사례는 신고·납부 가산세만 계산한 값입니다. 실제로는 세금계산서 미발급(2%), 사업자 미등록(1%) 등이 함께 적용될 수 있어 최종 부담은 더 커질 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-6 border-t border-border-base pt-8" data-speakable>
                ...
                <p className="mt-4">
                  ⚠️ 다만 감면의 절대 조건은 세무조사 통지 이전 자진 신고입니다. 조사 착수 후 수정신고분은 감면 대상에서 제외되며, 부정행위에 의한 가산세는 감면 폭이 제한되거나 배제될 수 있습니다. 또한 납부지연가산세(§47의4)는 §48 감면 대상이 아니므로 납부일까지 계속 누적됩니다.
                </p>
              </section>
