...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      '미등기 양도자산과 보유 3년 미만 자산은 공제되지 않습니다(소득세법 §95②, §104③). 국외 부동산도 장기보유특별공제 대상이 아닙니다(소득세법 §95②는 국내자산 대상, 국외자산은 §118의2 이하에 준용 규정 없음). 또한 조합원입주권은 원조합원의 주택분 양도차익에 한해 표1이 적용되는 등 자산별로 세부 규정이 다르므로, 개별 사례는 국세청 상담을 권합니다.',
  },
  {
            ...
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6 border-t border-border-base pt-8">
                ...
                <ul className="space-y-3 ml-6 list-disc text-text-secondary">
                  ...
                  <li>
                    <strong>국외 부동산:</strong> 해외 소재 부동산 양도는 장기보유특별공제 대상이 아닙니다. 장기보유특별공제는 국내 토지·건물 등을 대상으로 하고(소득세법 §95②), 국외자산 양도소득(소득세법 §118의2 이하)에는 준용 규정이 없기 때문입니다.
                  </li>
                  <li>
              ...
              <section className="space-y-4 rounded-lg border border-border-base bg-bg-card p-6">
                <p className="text-sm text-text-tertiary">
                  <strong>면책조항:</strong> 본 가이드는 교육 목적으로 작성되었으며 개인 맞춤형 세무 조언이 아닙니다. 실제 장기보유특별공제 적용 여부, 공제율, 세액은 자산 종류·보유 경위·중과 여부에 따라 달라지므로 국세청 홈택스 또는 세무 전문가에게 확인하세요. 본 콘텐츠는 2026-08-19 기준이며 세법 개정 시 업데이트됩니다. 인용 법조항: <strong>소득세법 §95②(장기보유 특별공제), §103(양도소득기본공제), §104③⑦, §118의2(국외자산 양도소득), 국세기본법 §14(실질과세)</strong>. AI 보조 작성 후 운영자 검수 완료.
                </p>
                <p className="text-sm text-text-tertiary">
                  <strong>참고 자료</strong>:{' '}
