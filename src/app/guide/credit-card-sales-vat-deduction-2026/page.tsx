          ...
          <main id="main-content" className="flex-1 px-4 py-8 md:px-8">
            <article className="mx-auto max-w-3xl space-y-8">
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 세금계산서를 발급하는 기업 간 거래(B2B) 매출은 이 공제 대상이 아닙니다. 카드·현금영수증·전자결제로 발행한 소비자 매출만 대상이라는 점을 혼동하지 마세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 이 제도는 그동안 여러 차례 한시 연장되며 1.3%·1,000만원 수준을 유지해왔습니다. 2027년 축소가 실제로 시행될지, 다시 연장될지는 세법 개정에 달려 있으므로 신고 시점의 규정을 국세청에서 확인하세요.
                </p>
              </section>
              ...
              <section className="space-y-6" data-speakable>
                ...
                <p className="mt-4">
                  다만 공제율·한도·대상은 세법 개정으로 자주 조정됩니다. 신고 시점의 정확한 기준은 반드시 국세청 홈택스와 세무 전문가를 통해 확인하세요.
                </p>
              </section>
