...
const STATUTE_REGISTRY = {
  '소득세법': new Set([
    ...
    '34', '37', '45', '47', '47의2', '48', '50', '51', '51의3', '52', '54', '55', '56',
    '57', '59', '59의2', '59의3', '59의4', '59의5', '62', '64의2', '64의4', '65',
    '67의3', '70', '70의2', '73', '74', '77', '79', '80', '81', '84', '85',
    '89', '92', '93', '94', '95', '97', '97의2', '98', '99', '100', '100의2',
    '101', '102', '103', '104', '104의2', '104의3', '104의7', '105', '118', '118의2',
    '127', '129', '134', '137', '138', '145', '146', '146의2',
    '160', '160의2', '160의5', '162의3',
  ]),
  '소득세법 시행령': new Set([
    '53', '87', '107', '118', '122의2', '133', '143', '145', '154', '154의4', '155',
    '155의3', '156', '159의3', '163의2', '208', '209',
  ]),
  '국세기본법': new Set([
  ...
  '조세특례제한법': new Set([
    '30', '30의5', '53', '58', '69', '86의2', '86의3', '89의2', '91', '95의2',
    '100의2', '100의3', '100의6', '126의7', '133',
  ]),
  '상속세 및 증여세법': new Set([
    '1', '3', '13', '18의2', '21', '26', '28', '31', '35', '41의4', '47', '50', '53',
    '53의2', '56', '66', '67', '68', '97의2',
  ]),
  '상속세 및 증여세법 시행령': new Set(['26', '31의5']),
  '지방세법': new Set([
    '3', '10', '11', '13', '13의2', '81', '92', '103의2', '107', '110', '111', '111의2',
    '112', '114', '117의2', '118', '122', '127', '128', '137', '150', '151',
  ]),
  '조세범처벌법': new Set(['73']),
};
