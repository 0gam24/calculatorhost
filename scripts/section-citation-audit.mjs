...
export const CITATION_EXEMPT = {
  ...
  '/guide/beotimok-jeonse-loan-conditions-2026/': '주택도시기금 버팀목 전세대출 상품 기준(기금운용계획) 기반 — 법률 §N 부재',
  ...
  '/guide/farmland-pension-2026/': '한국농어촌공사 농지연금 상품 기준(농지관리기금·상품약정) 기반 — 법률 §N 부재',
  '/guide/housing-subscription-account-conversion-2026/': '주택공급규칙(국토부령)·고시 기반 — 법률 §N 부재',
